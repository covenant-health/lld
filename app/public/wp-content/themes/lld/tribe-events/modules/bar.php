			...
			<?php if ( count( $views ) > 1 ) { ?>
				<div id="tribe-bar-views">
					<div class="tribe-bar-views-inner tribe-clearfix">
						...
						<select class="tribe-bar-views-select tribe-no-param form-group" name="tribe-bar-view">
				...
				<div class="tribe-bar-filters">
					<div class="tribe-bar-filters-inner tribe-clearfix">
						...
						<div class="tribe-bar-submit">
							<input class="tribe-events-button tribe-no-param btn btn-primary" type="submit"
							       name="submit-bar" value="<?php printf( esc_attr__( 'Find %s', 'the-events-calendar' ), tribe_get_event_label_plural() ); ?>" />
						</div>
						<!-- .tribe-bar-submit -->
					</div>
